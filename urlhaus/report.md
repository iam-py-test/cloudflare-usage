570 domains tested. 74.3859649122807% were behind nothing (146 were behind something). 26 domains could not be tested.<br>
0 used akamai (0.0%):
```
...
119 used cloudflare (20.87719298245614%):
```
...
1 used fastly (0.17543859649122806%):
```
visualwikicloud.com
```
